...
yes, we have missing values, such as in Sunshine and evaporation, which are of interest. 
...
weather_Portland$RainToday <- as.factor(weather_Portland$RainToday)
weather_Portland$RainTomorrow <- as.factor(weather_Portland$RainTomorrow)

Port_rain <- logistic_reg() %>%
  set_engine("glm") %>%
